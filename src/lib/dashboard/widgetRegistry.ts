...
export interface DashboardWidgetDefinition {
  ...
  title: string;
  /** Code-level default only — no persisted Dashboard Configuration exists yet
   * (Step 8). Every widget defaults visible; nothing here hides a widget based
   * on role or org today. */
  defaultVisible: true;
}

export const DASHBOARD_WIDGETS: DashboardWidgetDefinition[] = [
  { id: "plan_health", title: "Plan Health", defaultVisible: true },
  { id: "current_sprint", title: "Current Sprint", defaultVisible: true },
  { id: "roadmap_snapshot", title: "Roadmap Snapshot", defaultVisible: true },
  { id: "current_focus", title: "My Work / Current Focus", defaultVisible: true },
  { id: "initiative_summary", title: "Your Initiatives", defaultVisible: true },
  { id: "upcoming_timeline", title: "Upcoming Timeline", defaultVisible: true },
  { id: "attention", title: "Attention", defaultVisible: true },
  { id: "upcoming_actions", title: "Upcoming Actions", defaultVisible: true },
