...
const PROVIDERS: ProviderSeed[] = [
  {
    ...
    name: "Jira",
    category: "execution",
    description: "Sync epics, stories, acceptance criteria, sprint assignments, and demo issue keys.",
    isFeatured: true,
    ...
    capabilities: [
      ...
      { key: "generate_demo_keys", label: "Generate Demo Issue Keys" },
  ...
  },
  {
    ...
    description: "Link repositories and create demo issue references from stories.",
    isFeatured: false,
    supportsImport: true,
    supportsExport: true,
    displayOrder: 8,
    capabilities: [
      ...
      { key: "create_demo_issue_refs", label: "Create Demo Issue References" },
    ],
  },
];
